...
// Upwork has no lucide icon — inline the brand glyph
export function UpworkIcon({ className = '' }: { className?: string }) {
    return (
        <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
            <path d="M18.561 13.158c-1.102 0-2.135-.467-3.074-1.227l.228-1.076.008-.042c.207-1.143.849-3.06 2.839-3.06 1.492 0 2.703 1.211 2.703 2.703s-1.211 2.702-2.704 2.702zm0-8.145c-2.539 0-4.51 1.649-5.31 4.366-1.22-1.834-2.148-4.036-2.687-5.892H7.828v7.112a2.551 2.551 0 0 1-2.547 2.548 2.55 2.55 0 0 1-2.545-2.548V3.487H0v7.112c0 2.914 2.37 5.303 5.281 5.303 2.913 0 5.283-2.389 5.283-5.303v-1.19c.529 1.107 1.182 2.229 1.974 3.221l-1.673 7.873h2.797l1.213-5.71c1.063.679 2.285 1.109 3.686 1.109 3 0 5.439-2.452 5.439-5.45 0-3-2.439-5.439-5.439-5.439z" />
        </svg>
    );
}
...
const bioData = {
    ...
    social: {
        ...
        upwork: 'https://www.upwork.com/freelancers/~0173f50c6212e19412',
    },
            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <a
                            href={bioData.social.upwork}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-2 rounded-lg bg-white/5 border border-white/10 text-white/60 hover:text-[#6fda44] hover:bg-white/10 transition-all"
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center gap-6">
                ...
                <div className="flex sm:flex-col gap-2">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-2.5 rounded-xl bg-white/5 border border-white/10 text-white/60 hover:text-[#6fda44] hover:bg-white/10 transition-all"
                        title="Upwork Profile"
                    >
                        <UpworkIcon className="w-5 h-5" />
                    </a>
